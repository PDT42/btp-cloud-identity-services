...
To configure Identity Provisioning in the administration console of SAP Cloud Identity Services, your administrator user needs to be authorized to "Manage Identity Provisioning". For more informiation, see [Edit Administrator Authorizations](https://help.sap.com/docs/cloud-identity-services/cloud-identity-services/edit-administrator-authorizations?version=Cloud).
